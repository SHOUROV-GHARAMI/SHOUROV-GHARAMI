...
I’m a passionate **Software Engineer** focused on building **scalable**, **secure**, and **maintainable** web applications.  
My interests span across **frontend**, **backend**, and **database development**, with a strong focus on clean architecture and continuous learning.  
I enjoy solving complex problems and creating meaningful digital solutions that make an impact.  
...
![MVT](https://img.shields.io/badge/MVT-9C27B0?style=for-the-badge)
![REST API](https://img.shields.io/badge/REST_API-009688?style=for-the-badge)
![Microservices](https://img.shields.io/badge/Microservices-00BCD4?style=for-the-badge)
![Modular Design](https://img.shields.io/badge/Modular_Design-3F51B5?style=for-the-badge)
...
|-------------|----------------|----------------|
| 🔐 **Authify** | Secure authentication system with role-based access control | Django · REST API · PostgreSQL |
...
💬 Open to **internships**, **collaborations**, or **exciting project ideas**.  
